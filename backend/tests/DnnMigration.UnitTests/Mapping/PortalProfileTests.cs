...
public class PortalProfileTests
{
    ...
    public void Map_CreatePortalDto_To_Portal_CopiesFields_AndIgnoresIdentityAndDerivedMetrics()
    {
        ...
        var dto = new CreatePortalDto
        {
            ...
            KeyWords = "kw",
            BackgroundFile = "bg.png",
            // MIGRATION (INTEGRITY): GUID is excluded from CreatePortalDto (server-managed; PortalProfile ignores it on map). See MIGRATION_NOTES DEV-007.
            PaymentProcessor = "PayPal",
            ProcessorPassword = "pp",
            ProcessorUserId = "pu",
            SiteLogHistory = 60,
    ...
    public void Map_UpdatePortalDto_To_Portal_CopiesFields_AndIgnoresDerivedMetrics()
    {
        ...
        var dto = new UpdatePortalDto
        {
            ...
            // MIGRATION (INTEGRITY): GUID is excluded from UpdatePortalDto (server-managed; PortalProfile ignores it on map). See MIGRATION_NOTES DEV-007.
