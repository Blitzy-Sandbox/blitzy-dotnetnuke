...
public class PortalServiceTests
{
    ...
    // MIGRATION: build a REAL AutoMapper IMapper from the actual PortalProfile (projection fidelity).
    // The resolved AutoMapper (15.x) MapperConfiguration requires an ILoggerFactory argument; tests pass
    // NullLoggerFactory.Instance, matching the convention used by the sibling *ProfileTests in this project.
