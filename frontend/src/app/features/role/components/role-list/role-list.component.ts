...
export class RoleListComponent implements OnInit {
  ...
  readonly columns: DataTableColumn<Role>[] = [
    ...
    { key: 'autoAssignment', header: 'Auto', type: 'boolean' },
    {
      ...
      type: 'number',
      align: 'right',
      // MIGRATION: legacy FormatPrice rendered the service fee as ##0.00 and
      // returned Null.NullString (empty) for the Null.NullSingle sentinel; the
      // API maps that sentinel to null, so a null fee renders as an empty string.
