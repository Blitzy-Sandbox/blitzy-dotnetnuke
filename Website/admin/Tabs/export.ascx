...
<table style="width:560px;" cellspacing="1" cellpadding="1" border="0" summary="Edit Links Design Table">
	...
	<tr>
		<td class="SubHead" style="vertical-align:top; width:150px;"><dnn:label id="plAllModules" runat="server" controlname="chkAllModules" /></td>
		<td><asp:CheckBox id="chkAllModules" runat="server" /></td>
	</tr>
	<tr>
